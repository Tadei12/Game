...
lawsuit_music = "assets/sound/lawsuit.mp3"
...
class MenuButton:
    def __init__(self, rect_value, text, centered=False):
        self.x = rect_value[0]
        self.y = rect_value[1]
        self.w = rect_value[2]
        self.h = rect_value[3]
...
if language == "eng":
    ...
    Floor_button = ShopButton((550, 100), "Floor upgrade - 375$")

    Bunny_button = ShopButton((25, 350), "Bunny - 350$")
    Fox_button = ShopButton((550, 350), "Fox - 300$")
    Dog_button = ShopButton((25, 525), "Dog - 300$")

    FinishDay_button = MenuButton((10, 630, 200, 60), "Finish")

    CloseDown_Button = MenuButton((450, 600, 200, 60), "Close", True)
    ...
    Floor_button = ShopButton((550, 100), "Нова підлога - 375$")

    Bunny_button = ShopButton((25, 350), "Заєць - 350$")
    Fox_button = ShopButton((550, 350), "Лисиця - 300$")
    Dog_button = ShopButton((25, 525), "Собака - 300$")

    FinishDay_button = MenuButton((10, 630, 200, 60), "Далі")

    CloseDown_Button = MenuButton((450, 600, 200, 60), "Далі", True)
...
def menu():
    ...
    if menu_state == 0:
        ...
        if ContinueGame_button.update():
            ...
            if current_day == 8:
                pygame.mixer.music.load(lawsuit_music)
                pygame.mixer.music.play(-1)
...
def upgrades_shop():
    ...
    if language == "eng":
        draw_help("ESC - back", (0, 0, 0))
    else:
        draw_help("ESC - назад", (0, 0, 0))
...
def update_and_save():
    ...
    money += current_floor*25 + current_tables*50 + mascot_count*current_tables*25
...
def reset_office():
    ...
    global boot_time, night_percent, previous_percent
...
def final_lawsuit():
    window.fill((0, 0, 0))
    if language == "eng":
        draw_text("LAWSUIT", lawsuit_font, (550, 100), (255, 255, 255))
        draw_text("A minor was injured by a restaurant mascot.", lawsuit_font, (550, 150), (255, 255, 255))
        draw_text("Injuries included a broken bone and permanent scarring.", lawsuit_font, (550, 200), (255, 255, 255))
        draw_text("Settlement paid: $1400", lawsuit_font, (550, 225), (255, 255, 255))
        draw_text("The restaurant is forced to close down due to", lawsuit_font, (550, 275), (255, 255, 255))
        draw_text("recurring aggressive behavior from the mascots.", lawsuit_font, (550, 300), (255, 255, 255))
    else:
        draw_text("ПОЗОВ", lawsuit_font, (550, 100), (255, 255, 255))
        draw_text("Неповнолітній отримав травму від маскота ресторану.", lawsuit_font, (550, 150), (255, 255, 255))
        draw_text("Травми включали перелом кістки та постійний шрам.", lawsuit_font, (550, 175), (255, 255, 255))
        draw_text("Виплачена компенсація: $1400", lawsuit_font, (550, 225), (255, 255, 255))
        draw_text("Ресторан змушений закритися через", lawsuit_font, (550, 275), (255, 255, 255))
        draw_text("повторювану агресивну поведінку маскотів.", lawsuit_font, (550, 300), (255, 255, 255))
    
    if CloseDown_Button.update():
        global in_menu
        in_menu = True
