...
if language == "eng":
    ...
    Floor_button = ShopButton((550, 150), "Floor upgrade - 500$")
    ...
    Floor_button = ShopButton((550, 150), "Нова підлога - 500$")
...
def menu():
    global language, money, current_floor, current_tables
...
def upgrades_shop():
    ...
    if language == "eng":
        ...
        draw_text("Mascots", standart_font, (550, 350))
    else:
        draw_text("Інтер'єр", standart_font, (550, 100))
        draw_text("Маскоти", standart_font, (550, 350))
...
def LoadFunc():
    global settings, money, current_floor, current_tables
    with open("assets/dat.json", "r") as file:
        settings = json.load(file)
